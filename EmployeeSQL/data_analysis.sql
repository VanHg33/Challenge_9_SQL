...
select e.emp_no, e.first_name, e.last_name, e.sex, salaries.salary
from employees as e
...
--department name, employee number, last name, and first name.'
    --'join dep_manager and departments to get departments names'
	--'join new table with employees to get manager names'
